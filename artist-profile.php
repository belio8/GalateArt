                        ...
                        <?php else: ?>
                            <?php foreach ($postRows as $post): ?>
                                ...
                                <div class="art-card <?= !empty($post['is_nsfw']) ? 'is-nsfw' : '' ?>" style="cursor: pointer;"
                                    ...
                                    <div class="card-avatar-wrap" onclick="event.stopPropagation(); window.location.href='artist-profile.php';">
                                    ...
                                    <div class="art-info">
                                        <p class="art-title"><?php echo htmlspecialchars($post['title'] ?: 'Postingan'); ?></p>
